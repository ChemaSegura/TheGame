...
1. Rechaza llamadas si el juego ya terminó.
2. Incrementa los contadores de intentos.
3. Emite el evento GuessMade.
4. Si el número es correcto:
5. Finaliza el juego
6. Registra al ganador
7. Emite el evento GameWon
